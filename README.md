...
Документация по пакету русской локализации находится в [**WIKI**](https://github.com/pkgstore/flarum-l10n-core-russian/wiki).
...
2. [неофициальная](https://github.com/pkgstore/flarum-l10n-core-russian).
